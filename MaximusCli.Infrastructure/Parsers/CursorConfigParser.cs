...
/// <summary>
/// Parses Cursor MCP configuration files into the domain model.
/// </summary>
public class CursorConfigParser : IConfigParser
{
    public string AgentName => "cursor";

    public string[] SupportedVersions => new[] { "1.0", "0.1" };
    ...
    public async Task<ConversionResult> ParseAsync(string filePath)
    {
        try
        {
            ...
            {
                config.Version = versionElement.GetString() ?? "1.0";
            }
