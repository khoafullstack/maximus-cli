...
/// <summary>
/// Writes MCP configuration to Roo Code format.
/// </summary>
public class RooCodeConfigWriter : IConfigWriter
{
    ...
    public async Task<ConversionResult> WriteAsync(McpConfig config, string outputPath)
    {
        try
        {
            ...
            // Build Roo Code JSON structure
            var rooCodeConfig = new Dictionary<string, object>
            {
            ...
            string jsonContent = JsonSerializer.Serialize(rooCodeConfig, options);
